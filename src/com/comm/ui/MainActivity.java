...
public class MainActivity {
	...
	private boolean autoSendState = false;
	private Thread autoSendThread; // 知道发送线程
    ...
    private static  TimeSeries s1 = new TimeSeries("tep");
    private static  TimeSeries s2 = new TimeSeries("noice");
	...
	protected void createContents() {
		...
		content_fd.bottom = new FormAttachment(0); // 宽占shell(窗口)宽的60%
		content_fd.left = new FormAttachment(0);
		content_fd.right = new FormAttachment(0); // 高占shell(窗口)高的60%
//		content_fd.bottom = new FormAttachment(60); // 宽占shell(窗口)宽的60%
//		content_fd.left = new FormAttachment(40);
//		content_fd.right = new FormAttachment(100); // 高占shell(窗口)高的60%
...
//		frame.setLayout(new FillLayout(SWT.HORIZONTAL));
		...
		left_top_cps.setLayoutData(left_top_fd);
		{
			...
			left_top_cps_below.setLayoutData(left_top_fd_2);
			{
				...
				Button startButton = new Button(left_top_cps_below, SWT.NONE);
		...
		mid_cps.setLayoutData(mid_fd); // // 高占shell 60%,宽占shell35%
		{
